DiscountCoin-qt: Qt5 GUI for DiscountCoin
===============================
...
A warning for people using the *static binary* version of DiscountCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of DiscountCoin is linked against libdb 5.0 (see also `this Debian issue`_).
