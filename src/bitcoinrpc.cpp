...
{
    return GetBoolArg("-testnet", false) ? 25715 : 15632;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop DiscountCoin server (and possibly override the detachdb config value).");
...
void ThreadRPCServer(void* parg)
{
    ...
    RenameThread("DiscountCoin-rpclist");
...
void ThreadRPCServer3(void* parg)
{
    ...
    RenameThread("DiscountCoin-rpchand");
